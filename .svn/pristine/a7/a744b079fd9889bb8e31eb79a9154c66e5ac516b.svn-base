...
- (void)requestFromURL:(NSString *)url method:(NSString *)method identifier:(NSString *)identifier completion:(void (^)(BOOL finished, NSData *responseData, NSString *responseString, NSError *error))completion;
