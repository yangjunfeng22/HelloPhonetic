...
- (id)initWithTableView:(UITableView *)aTableView cellIdentifier:(NSString *)aCellIdentifier fetchedResultsController:(NSFetchedResultsController *)aFetchedResultsController
{
    if (self = [super init])
    {
        self.tableView = aTableView;
